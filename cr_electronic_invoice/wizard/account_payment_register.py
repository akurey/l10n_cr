    ...
    def _create_payments(self):
        ...
        if invoice and payment.payment_type == 'inbound':
            ...
            if invoice.rep_string:
                ...
                print("estado:", estado_m_h)
                
                if estado_m_h != 'procesando':
                    print(response_json_consulta_clave.get('respuesta-xml'))
