...
schemaLocation = {
    ...
    'Electronico/docs/esquemas/2016/v4.4/NotaDebitoElectronica_V4.4.xsd',
    'NC': 'https://www.hacienda.go.cr/ATV/Comprobante' +
    'Electronico/docs/esquemas/2016/v4.4/NotaCreditoElectronica_V4.4.xsd',
    ...
    'Electronico/docs/esquemas/2016/v4.4/FacturaElectronicaCompra_V4.4.xsd',
    'FEE': 'https://www.hacienda.go.cr/ATV/Comprobante' +
    'Electronico/docs/esquemas/2016/v4.4/FacturaElectronicaExportacion_V4.4.xsd',
    'REP': 'https://www.hacienda.go.cr/ATV/Comprobante' +
    'Electronico/docs/esquemas/2024/v4.4/ReciboElectronicoPago_V4.4.xsd',
}
